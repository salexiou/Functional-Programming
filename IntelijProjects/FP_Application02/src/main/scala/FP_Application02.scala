...
object FP_Application02 extends App{
  ...
  val spark = SparkSession
    .builder
    .master("local[*]")
    .appName("Application_02")
    .getOrCreate()

  //val hdfs = FileSystem.get(spark.sparkContext.hadoopConfiguration)

  val path = "hdfs://localhost:9000/FinalProjectData/Data_Exercise_2"

  val dataPath = path + "/nmea_aegean.logs"

  val OutputPath01 = "hdfs://localhost:9000/outputFiles_App2/Question1"
  val OutputPath02 = "hdfs://localhost:9000/outputFiles_App2/Question2"
  val OutputPath03 = "hdfs://localhost:9000/outputFiles_App2/Question3"
  val OutputPath04 = "hdfs://localhost:9000/outputFiles_App2/Question4"
  val OutputPath05 = "hdfs://localhost:9000/outputFiles_App2/Question5"
  ...
  // Create a column with the extracted date from the date - time timestamp
